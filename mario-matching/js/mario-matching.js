window.onload = ()=>{
  ...
  //document.querySelector("#level").innerHTML = `Level: ${levelCount}`;
  //initBoard(deck);
}
const numCards = 12;
let gameEnded = false;
...
let timer;
const fullLives = `<img src="images/heart.webp">
      <img src="images/heart.webp">
      <img src="images/heart.webp">
      <img src="images/heart.webp">
      <img src="images/heart.webp">`
let numLives = fullLives;
let gameStart = false;
...
function initBoard(gameDeck){
  ...
  newDeck = [...gameDeck];
  newDeck.sort(()=>{ return 0.5 - Math.random() }); // randomize the deck
...
function tick() {
  ...
  {
    document.querySelector("#cards").innerHTML = `Game Over<br>Press the button to start again`;
...
{
  let numChars = 36;
  let numLives = document.querySelector("#lives").innerHTML;
  if (lives.value == 4)
  {
    lives.value--;
    livesLost.value++;
    ...
    numLives = numLives.slice(numChars);
    document.querySelector("#lives").innerHTML = numLives;
  }
...
function nextLevel()
{
  ...
  clicks = 0;
  document.querySelector("#clicks").innerHTML = `Clicks: ${clicks}`;
  document.querySelector("#lives").innerHTML = fullLives;
  numLives = fullLives;
  gameEnded = false;
  if (levelCount == 2)
  {
  ...
  else
  {
    ...
    document.querySelector("#level").innerHTML = "Level: Completed!"
    /*
    document.querySelector("#clicks").innerHTML = `Total Clicks: ${totalClicks}`;
    document.querySelector("#score").innerHTML = `Final Score: ${score.value}`;
    */
...
function gameOver()
{
  ...
  document.querySelector("#clicks").innerHTML = `Total Clicks: ${totalClicks}`;
  document.querySelector("#score").innerHTML = `Final Score: ${score.value}`;
  document.querySelector("#button").innerHTML = `<button type="button" onclick="startButtonClicked()">Let's-A-Go!!!!</button>`;
}
